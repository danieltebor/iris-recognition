# -*- coding: utf-8 -*-
"""
Module: cnn_wide_input_model_operator.py
Author: Daniel Tebor
Description: This module contains a class for training and evaluating the ResNet50 model with multi-image input acheived by inputing a wide image.
"""
...
class CNNWideInputModelOperator(CNNModelOperator):
    def __init__(self,
                 model: nn.Module,
                 modelname: str,
