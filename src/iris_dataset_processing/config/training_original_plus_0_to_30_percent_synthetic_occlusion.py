# -*- coding: utf-8 -*-
"""
Module: training_original_plus_0_to_30_percent_synthetic_occlusion.py
Author: Daniel Tebor
Description: This module contains the configuration for training a model 
             on the original iris occlusion distribution plus 0 to 30 percent synthetic occlusion.
"""
...
TRAINING_DERIVED_MODEL_DESCRIPTOR = 'original_plus_0_to_30_percent_synthetic_occlusion'
