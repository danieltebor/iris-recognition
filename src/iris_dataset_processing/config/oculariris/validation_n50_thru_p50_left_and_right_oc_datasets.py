...
# -50
_negative_50_config = {
    'cohorts': [IrisDatasetCohort.OCULARIRIS_OC_LEFT, IrisDatasetCohort.OCULARIRIS_OC_RIGHT],
    'left_eye_cohorts': [IrisDatasetCohort.OCULARIRIS_OC_LEFT],
    'right_eye_cohorts': [IrisDatasetCohort.OCULARIRIS_OC_RIGHT],
