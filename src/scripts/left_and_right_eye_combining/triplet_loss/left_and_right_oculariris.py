...
from iris_dataset_processing.config.oculariris.triplet_loss.complete_anchor_left_and_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.training_anchor_left_and_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.testing_anchor_left_and_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.training_left_and_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.testing_left_and_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.validation_n50_thru_p50_left_and_right_oc_datasets import *
...
MODELNAME = 'resnet50'
MODEL_FILENAME = f'{MODELNAME}_triplet_loss_left_and_right_oculariris_new.pt'
