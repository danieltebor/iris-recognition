...
from iris_dataset_processing.config.oculariris.triplet_loss.complete_anchor_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.training_anchor_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.testing_anchor_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.training_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.testing_right_oc_dataset import *
from iris_dataset_processing.config.oculariris.triplet_loss.validation_n50_thru_p50_right_oc_datasets import *
...
MODELNAME = 'resnet50'
MODEL_FILENAME = f'{MODELNAME}_triplet_loss_right_oculariris_new.pt'
