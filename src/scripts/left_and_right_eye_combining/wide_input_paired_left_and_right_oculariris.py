...
MODELNAME = 'resnet50'
MODEL_FILENAME = f'{MODELNAME}_wide_input_{TRAINING_DERIVED_MODEL_DESCRIPTOR}.pt'
...
def train():
    ...
    model_operator = model_operator_factory.create_model_operator(ModelOperatorName.WIDE_INPUT)
