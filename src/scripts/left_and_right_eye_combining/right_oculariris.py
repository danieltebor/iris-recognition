# -*- coding: utf-8 -*-
"""
Module: resnet50_right_oculariris.py
Author: Daniel Tebor
"""
...
from iris_dataset_processing.config.training_right_oculariris_dataset import *
from iris_dataset_processing.config.testing_right_oculariris_dataset import *
from iris_dataset_processing.config.validation_n50_thru_p50_right_oculariris_datasets import *
...
MODELNAME = 'resnet50'
MODEL_FILENAME = f'{MODELNAME}_{TRAINING_DERIVED_MODEL_DESCRIPTOR}.pt'
...
def train():
    ...
    model_operator = model_operator_factory.create_model_operator(ModelOperatorName.CNN)
